...
export default async function SignupPage({
  ...
  async function signUp(formData: FormData) {
    ...
    // After signup, confirm and redirect to login
    ...
    <div className="flex min-h-[calc(100vh-3.5rem-4rem)] items-center justify-center px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Sign up to purchase and download Chinese learning materials.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {params.error && (
          ...
          {new URLSearchParams(await searchParams).get("confirmed") && (
